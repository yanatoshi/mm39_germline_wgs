...
vep \
        -i ${workingdir}/${sample}/germline_gatk_dir/${sample}_chrmergedall.passfilterd.vcf.gz \
        -o ${workingdir}/${sample}/germline_gatk_dir/${sample}_vep_ensembl_annotated.vcf.gz \
        --stats_file ${workingdir}/${sample}/germline_gatk_dir/${sample}_variant_effect_output_ensembl.txt_summary.html \
        --fasta ${ref_fasta} \
        --dir_cache /mnt/scratch3/yanagiwasa/dry_yanagisawa/reference/mm39/vep_ensembl/cache \
        --dir_plugins /mnt/scratch3/yanagiwasa/dry_yanagisawa/reference/mm39/vep_ensembl/plugins \
